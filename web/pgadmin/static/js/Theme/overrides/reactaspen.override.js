...
export default function reactAspenOverride(theme) {
  return {
    '.drag-tree-node': {
      ...
      left: 0,
      zIndex: 99999,
      color: theme.otherVars.tree.treeTextFg,
      background: theme.otherVars.tree.treeInputBg,
    ...
    '.file-tree': {
      color: theme.otherVars.tree.treeTextFg + ' !important',
      backgroundColor: theme.otherVars.tree.treeInputBg + ' !important',
    ...
    '.file-entry': {
      ...
      '&:hover, &.pseudo-active': {
        color: theme.otherVars.tree.treeTextHoverFg + ' !important',
        backgroundColor: theme.otherVars.tree.treeBgHover + ' !important',
        'span.file-label': {
          'span.file-name': {
            color: theme.otherVars.tree.treeTextHoverFg,
          },
        },
      },
      ...
      '&.active, &.prompt': {
        ...
        borderColor: theme.otherVars.tree.treeBgSelected,
        borderRight: '3px solid ' + theme.palette.primary.main + ' !important',
        'span.file-label': {
          'span.file-name': {
            color: theme.otherVars.treeTextHoverFg,
          },
        },
      },
      ...
      'span.file-label': {
        ...
        marginLeft: '2px',
        '&:hover, &.pseudo-active': {
          color: theme.otherVars.tree.treeFgHover,
        },
      },
