...
var imageMapper = {
    "Aggregate" : {
        "image":"ex_aggregate.svg", "image_text":"Aggregate"
    },
    'Append' : {
        "image":"ex_append.svg","image_text":"Append"
    },
    "Bitmap Index Scan" : function(data) {
        return {
            "image":"ex_bmp_index.svg", "image_text":data['Index Name']
        };
    },
    "Bitmap Heap Scan" : function(data) {
  return {"image":"ex_bmp_heap.svg","image_text":data['Relation Name']};
},
...
"Hash Join": function(data) {
  if (!data['Join Type']) return {"image":"ex_join.svg","image_text":"Join"};
  switch(data['Join Type']) {
    case 'Anti': return {"image":"ex_hash_anti_join.svg","image_text":"Hash Anti Join"};
    case 'Semi': return {"image":"ex_hash_semi_join.svg","image_text":"Hash Semi Join"};
    default: return {"image":"ex_hash.svg","image_text":String("Hash " + data['Join Type'] + " Join" )};
  }
},
"HashAggregate" : {"image":"ex_aggregate.svg","image_text":"Hash Aggregate"},
"Index Only Scan" : function(data) {
  return {"image":"ex_index_only_scan.svg","image_text":data['Index Name']};
},
"Index Scan" : function(data) {
  return {"image":"ex_index_scan.svg","image_text":data['Index Name']};
},
...
"Merge Join": function(data) {
  switch(data['Join Type']) {
    case 'Anti': return {"image":"ex_merge_anti_join.svg","image_text":"Merge Anti Join"};
    case 'Semi': return {"image":"ex_merge_semi_join.svg","image_text":"Merge Semi Join"};
    default: return {"image":"ex_merge.svg","image_text":String("Merge " + data['Join Type'] + " Join" )};
  }
},
"ModifyTable" : function(data) {
  switch (data['Operation']) {
    case "Insert": return { "image":"ex_insert.svg",
                            "image_text":"Insert"
                           };
    case "Update": return {"image":"ex_update.svg","image_text":"Update"};
    case "Delete": return {"image":"ex_delete.svg","image_text":"Delete"};
  }
},
'Nested Loop' : function(data) {
  switch(data['Join Type']) {
    case 'Anti': return {"image":"ex_nested_loop_anti_join.svg","image_text":"Nested Loop Anti Join"};
    case 'Semi': return {"image":"ex_nested_loop_semi_join.svg","image_text":"Nested Loop Semi Join"};
    default: return {"image":"ex_nested.svg","image_text":"Nested Loop " + data['Join Type'] + " Join"};
  }
},
  ...
  if(strategy == "Hashed") {
    if(S.startsWith(command, "Intersect")) {
      if(command == "Intersect All")
        return {"image":"ex_hash_setop_intersect_all.svg","image_text":"Hashed Intersect All"};
      return {"image":"ex_hash_setop_intersect.svg","image_text":"Hashed Intersect"};
    }
    else if (S.startsWith(command, "Except")) {
      if(command == "Except All")
        return {"image":"ex_hash_setop_except_all.svg","image_text":"Hashed Except All"};
      return {"image":"ex_hash_setop_except.svg","image_text":"Hash Except"};
    }
    return {"image":"ex_hash_setop_unknown.svg","image_text":"Hashed SetOp Unknown"};
  }
  return {"image":"ex_setop.svg","image_text":"SetOp"};
},
"Seq Scan": function(data) {
  return {"image":"ex_scan.svg","image_text":data['Relation Name']};
},
...
"Undefined" : {"image":"ex_unknown.svg","image_text":"Undefined"},
}
    ...
    parse: function(data) {
        ...
        var mappedImage = (_.isFunction(imageMapper[node_type]) &&
                ...
                imageMapper[node_type] || {
                  "image": "ex_unknown.svg", "image_text": node_type
                };
