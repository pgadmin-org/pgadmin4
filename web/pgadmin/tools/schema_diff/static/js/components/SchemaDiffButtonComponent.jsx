    ...
    <>
      <Box className={classes.compareBtn}>
        <PgButtonGroup size="small" disabled={isDisableCompare}>
          ...
          <PgIconButton title={isDisableCompare? '':gettext('Compare')} icon={<KeyboardArrowDownIcon />} color={'primary'} splitButton
      ...
      <Box className={classes.filterBtn}>
        <PgButtonGroup size="small" disabled={isDisableCompare} style={{ paddingRight: '0.3rem' }}>
          ...
          <PgIconButton title={isDisableCompare? '':gettext('Filter')} icon={<KeyboardArrowDownIcon />} splitButton
