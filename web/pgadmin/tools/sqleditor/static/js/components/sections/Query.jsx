...
export default function Query({onTextSelect, setQtStatePartial}) {
  ...
  useDelayDebounce((saveQtData) => {
    let connection_info = _.find(queryToolCtx.connection_list, c => c.is_selected);
    saveToolData('sqleditor', connection_info, queryToolCtx.params.trans_id, saveQtData);
  }, saveQtData, 500);
