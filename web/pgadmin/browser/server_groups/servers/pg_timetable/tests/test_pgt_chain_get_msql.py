...
class PgtChainGetMsqlTestCase(BaseTestGenerator):
    """This class will test the msql for pgTimetable chain API"""
    scenarios = utils.generate_scenarios("pgt_chain_msql",
    ...
    def runTest(self):
        """This function will get msql for pgTimetable chain"""

        if self.is_positive_test:
            url_encode_data = self.data

            response = pgt_utils.api_get_msql(self, url_encode_data)
