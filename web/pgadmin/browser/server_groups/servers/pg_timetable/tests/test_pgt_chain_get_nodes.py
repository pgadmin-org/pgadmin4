...
class PgtChainGetNodesTestCase(BaseTestGenerator):
    """This class will test the get pgTimetable chain nodes API"""
    scenarios = utils.generate_scenarios("pgt_chain_get_nodes",
    ...
    def setUp(self):
        ...
        if self.is_list:
            name_2 = "test_chain_get_nodes%s" % str(uuid.uuid4())[1:8]
            self.chain_id_2 = pgt_utils.create_pgtimetable_chain(self, name_2)

    def runTest(self):
        """This function will get pgTimetable chain nodes"""
