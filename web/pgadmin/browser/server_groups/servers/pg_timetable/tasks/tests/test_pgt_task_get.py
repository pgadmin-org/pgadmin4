...
class PgtTaskGetTestCase(BaseTestGenerator):
    """This class will test the get pgTimetable chain task API"""
    scenarios = utils.generate_scenarios("pgt_task_get",
