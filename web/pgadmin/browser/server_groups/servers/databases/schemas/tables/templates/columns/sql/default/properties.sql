...
SELECT DISTINCT ON (att.attnum) att.attname as name, att.atttypid, att.attlen, att.attnum, att.attndims,
	...
	defseqdep.refobjid AS defseqrelid,
	seq.*
FROM pg_catalog.pg_attribute att
  ...
  LEFT OUTER JOIN pg_catalog.pg_depend defseqdep ON defseqdep.classid='pg_catalog.pg_attrdef'::regclass AND defseqdep.objid=def.oid AND defseqdep.deptype='n' AND defseqdep.refclassid='pg_catalog.pg_class'::regclass
